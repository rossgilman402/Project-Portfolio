      ...
      <div className="about-container">
        <div className="title-container">
          ...
          <p>
            ...
            passion for lifelong learning. Known for my creative
            problem-solving, attention to detail, and strong collaboration
            skills, I thrive in the tech world with a commitment to continuous
            growth and nurturing a growth mindset.
          </p>
        </div>
